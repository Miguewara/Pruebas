package daw2020.album;
	 ...
	 */
	public class CancionesFileException
			extends Exception {
		 ...
		 */
		public CancionesFileException(String mensaje) {
			super(mensaje);
		}
		 ...
		 */
		public CancionesFileException(Throwable causa) {
			super(causa);
		}
